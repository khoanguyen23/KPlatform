...
const navigationMenuTriggerStyle = cva(
  "inline-flex text-slate-600 hover:text-slate-900 items-center justify-center rounded-md text-sm hover:scale-105 font-medium transition-colors disabled:opacity-50 disabled:pointer-events-none bg-transparent dark:text-slate-100 dark:hover:text-cyan-600 data-[active]:bg-slate-50 dark:data-[active]:bg-slate-800 h-10 py-2 px-4 w-max group"
)
